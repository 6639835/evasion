...
export function PhilosophySection() {
  ...
  return (
    <section id="products" className="bg-background">
      ...
      <div ref={sectionRef} className="relative" style={{ height: "200vh" }}>
        <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden">
          <div className="relative w-full">
            ...
            >
              <h2 className="text-[9vw] font-medium leading-[0.95] tracking-tighter text-foreground sm:text-[10vw] md:text-[8vw] lg:text-[6.5vw] text-center px-6">
                {t("title")}
              </h2>
            </div>
            ...
            <div className="relative z-10 grid grid-cols-1 gap-4 px-6 md:grid-cols-2 md:px-12 lg:px-20">
              ...
              >
                <Image
                  src="/images/bottle-forest-hands.png"
                  alt={t("alt.forest")}
                  fill
                  className="object-cover"
                />
      ...
      {/* Description */}
      <div className="px-5 py-14 sm:px-6 sm:py-20 md:px-12 md:py-28 lg:px-20 lg:py-36 lg:pb-14">
        <div className="text-center">
          <p className="text-xs uppercase tracking-widest text-muted-foreground">
            {t("eyebrow")}
          </p>
          <p className="mt-8 leading-relaxed text-muted-foreground text-xl text-center sm:text-2xl md:text-3xl">
            {t("description")}
          </p>
        </div>
      </div>
